...
export const projects: Project[] = [
  {
    id: 'axiomancer',
    title: 'Axiomancer',
    description: 'Advanced AI chat platform with multi-model routing system and customization functions.',
    category: 'AI/ML',
    date: '2025-12-19',
    featured: true,
    color: '#9400D3',
    icon: 'brain',
    techStack: ['Svelte 5', 'TypeScript', 'ElysiaJS', 'Bun', 'PostgreSQL', 'JWT', 'WebSocket', 'CORS', 'Swagger', 'i18n', 'KaTeX'],
    ...
    images: ['/projects/axiomancer-hero.png', '/projects/axiomancer-dashboard.png', '/projects/axiomancer-routing.png']
  },
  {
    id: 'axionsync',
    title: 'AxionSync',
    description: 'Comprehensive personal life management platform bringing everything important together.',
    category: 'Full Stack',
    date: '2025-11-04',
    featured: true,
    color: '#FF7F00',
    icon: 'sync',
    techStack: ['Next.js 16', 'React 19', 'TypeScript', 'Mantine UI', 'Ant Design', 'Framer Motion', 'Zustand', 'next-intl', 'Tailwind CSS 4', 'Turbo'],
  ...
  },
  {
    ...
    color: '#00BFFF',
    icon: 'globe',
    techStack: ['Astro 5', 'ElysiaJS', 'TypeScript', 'PostgreSQL', 'Supabase', 'Zustand', 'JWT', 'CORS', 'Swagger', 'Sitemap'],
    longDescription: 'PrismPioneer is a modern portfolio and blog website built with Astro 5 for optimal performance and SEO. The site features a clean design with smooth animations, responsive layouts, and server-side rendering. Backend powered by ElysiaJS with Bun runtime, PostgreSQL database, and Supabase for storage.',
    implementation: [
  ...
  },
  {
    ...
    description: 'VS Code extension to identify repeated string literals and improve code maintainability.',
  ...
  },
  {
    id: 'colorflow',
    title: 'ColorFlow',
    description: 'VS Code extension to visualize inline CSS colors in HTML documents with configurable background highlighting.',
    category: 'VSCode Extension',
    date: '2026-01-28',
    featured: true,
    color: '#FFD700',
  ...
  },
  {
    ...
    longDescription: 'An engaging HTML/JavaScript game project built using the simpleGame.js custom framework. The game features sprite-based graphics, audio effects, and smooth gameplay mechanics. Built entirely with vanilla HTML5 and JavaScript for maximum browser compatibility.',
    implementation: [
  ...
  },
  {
    ...
    longDescription: 'A collection of puzzle games built with HTML5 and JavaScript, featuring multiple game types including a 2048 variant and BoxBox. The games are designed with clean, intuitive interfaces and responsive layouts for play on any device.',
    implementation: [
